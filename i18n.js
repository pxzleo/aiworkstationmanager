...
(function initializeI18n() {
  ...
  const translations = {
    ...
    '用户管理': 'User Management', '日志中心': 'Operation Log', '视频任务': 'Video Jobs',
    'RTX 4090 串行调度': 'RTX 4090 Serial Scheduling', '刷新任务': 'Refresh Jobs',
    '任务仅由本机 OpenCode 提交；这里显示完整阶段、ComfyUI prompt_id、输出和恢复结果，并允许取消。': 'Jobs are submitted only by local OpenCode. This page shows every stage, ComfyUI prompt_id, output, recovery result, and cancellation control.',
    'AXIS 会等待 NInfer processing 与 deferred 同时为 0，之后才允许切换到 Video Gen。': 'AXIS waits until NInfer processing and deferred are both zero before switching to Video Gen.',
    '尚无视频任务。': 'No video jobs.', '取消任务': 'Cancel Job',
    '等待调度': 'Waiting for scheduler', '等待 NInfer 空闲': 'Waiting for NInfer idle',
    '切换 Video Gen': 'Switching to Video Gen', '检查 ComfyUI': 'Checking ComfyUI',
    '提交工作流': 'Submitting workflow', 'ComfyUI 生成中': 'Generating in ComfyUI',
    '收集输出': 'Collecting output', '恢复 Code Agent': 'Restoring Code Agent',
    '验证 NInfer': 'Verifying NInfer', '回调 OpenCode': 'Calling back OpenCode',
    ...
    '场景用途': 'Scene purpose', '普通场景': 'Standard scene', 'Code Agent': 'Code Agent', 'Video Gen': 'Video Gen',
    'Code Agent 与 Video Gen 各只能指定一个场景，供视频调度器安全切换。': 'Only one Code Agent and one Video Gen scene can be assigned for safe video scheduling.',
