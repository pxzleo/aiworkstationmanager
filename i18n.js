...
(function initializeI18n() {
  ...
  const translations = {
    ...
    '在这里准备任务内容；通过 OpenCode 的自动任务 Skill 启动后，将按创建顺序逐项执行。': 'Prepare task instructions here. After the OpenCode automatic-task skill starts, tasks run one at a time in creation order.',
